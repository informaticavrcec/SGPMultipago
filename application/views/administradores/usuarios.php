...
<td><input type="text" id="rut" name="rut" value="<?=set_value('rut')?>" size="90" placeholder="Buscar por nombres y/o apellidos" /> <a href="/administrador/agregarusuario" class="popup btn_normal">Agregar usuario</a></td>
</tr>
</table>
</form>
