...
<table width="100%" border="0" cellpadding="3" cellspacing="0" align="center">
<tr>
<td width="80" align="center" style="border-top:#CCC 1px solid;border-left:#CCC 1px solid;" ><strong>Empresa</strong></td>
<td width="80" style="background-color:#F4F4F4;border:#CCC 1px solid" align="center"><a href="/caja/pago/5555/<?=$idpostulacionitem?>" style="text-decoration:none;color:#666;" >OTIC</a></td>
...
<tr>
<td valign="top" style="padding-top:5px;"><strong>Descripción</strong></td>
...
<tr>
<td ><strong>No. Orden compra</strong></td>
<td><input type="text" name="orden_empresa" value="<?=$facturar_empresa->NOC_Empresa?>" class="right" style="width:97.5%" maxlength="25" /></td>
</tr>
<tr>
...
<tr>
<td colspan="2" height="40"><input type="submit" value="Guardar" /></td>
</tr>
</table>
