...
foreach($seccion as $valor){
	?>
    <tr >
    <td colspan="2"><?=$valor['IDSeccion']?> - <?=$valor['Nombre_Curso']?><span class="show_detail detail" id="<?=$valor['IDPostulacionItem']?>" >ver detalle</span></td>
    <td width="100" align="right"><strong style="float:left">$</strong><strong><?=number_format($valor['ValorNuevo'],0,',','.')?></strong></td>
    <td width="100" align="right">&nbsp;</td>
    </tr>
  <tr class="<?=$valor['IDPostulacionItem']?> hide row2" >
...
<td align="right" bgcolor="#FFFFCC" width="100" ><strong style="float:left">$</strong> <strong><?=number_format($total_arecaudar,0,',','.')?></strong></td>
...
foreach($pagos as $value){
	...
	foreach($value['detalle'] as $val){
		?>
        <tr class="<?=$value['IDTipoPago']?> hide row" >
        <td></td>
        <td><?=$val['detalle']?></td>
...
<td align="right" bgcolor="#FFFFCC" ><strong style="float:left">$</strong><strong><?=number_format($suma_final,0,',','.')?></strong></td>
