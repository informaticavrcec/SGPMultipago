...
<form method="get" action="/caja/documento/<?=$idpostulacionitem?>">
...
if($suma_boletas > 0){
    ...
    <tr>
    <td height="40"><a href="/asignarboletasfacturas/boleta/<?=base64_decode($idpostulacionitem)?>" class="btn_normal popup_short2" >Asignar boleta</a></td>
    </tr>
    </table><?	
}
if($suma_facturas > 0){
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
    <td height="40"><a href="/asignarboletasfacturas/factura/<?=base64_decode($idpostulacionitem)?>" class="btn_normal popup_short2" >Asignar factura</a></td>
    </tr>
    </table><?
}?>
</body>
