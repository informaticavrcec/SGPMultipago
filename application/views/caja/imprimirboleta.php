...
<tr>
  <td>&nbsp;</td>
<td><?
foreach($detalleactividad as $actividad){
	echo $actividad['Nombre_Curso'].' '.$actividad['es_admision'].' // ';
}?></td>
</tr>
<tr>
  <td>&nbsp;</td>
...
foreach($detalleactividad as $proyecto){	
...
<tr>
  <td>&nbsp;</td>
<td>Periodo: <?
foreach($detalleactividad as $periodo){
	echo $periodo['FechaInicio'].' al '.$periodo['FechaTermino'].' // ';
}?></td>
</tr>
<tr>
  <td>&nbsp;</td>
